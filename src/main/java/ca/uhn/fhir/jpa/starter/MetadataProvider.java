...
/*public class MetadataProvider {
  ...
  public CapabilityStatement getServerMetadata() {
      ...
      metadata.setTitle("Da Vinci PCT Reference Implementation");
      metadata.setStatus(PublicationStatus.DRAFT);
      metadata.setExperimental(true);
      metadata.setPublisher("Da Vinci");
      ...
      metadata.addImplementationGuide("https://build.fhir.org/ig/HL7/davinci-pct/index.html");
  ...
  private void updateRestComponents(
    ...
    for(CapabilityStatementRestComponent rest : originalRests) {
      ...
      for(CapabilityStatementRestResourceComponent resource : resources) {
        ...
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-coverage");
        // } else if (resource.fhirType().equals("Bundle")) {
        //   resource.addSupportingProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-aeob-bundle");
        //   resource.addSupportingProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-gfe-bundle-institutional");
        //   resource.addSupportingProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-gfe-bundle-professional");
        // } else if (resource.fhirType().equals("Claim")) {
        //   resource.addSupportingProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-gfe-professional");
        //   resource.addSupportingProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/pct-gfe-Institutional");
        // } else if (resource.fhirType().equals("ExplanationOfBenefit")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-aeob");
        // } else if (resource.fhirType().equals("Location")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-location");
        // } else if (resources.fhirType().equals("Organization")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-organization");
        // } else if (resource.fhirType().equals("Patient")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-patient");
        // } else if (resources.fhirType().equals("Practitioner")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-practitioner");
        // } else if (resource.fhirType().equals("PractitionerRole")) {
        //   resource.setProfile("http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-practitionerrole");
        // }
      }
    }
