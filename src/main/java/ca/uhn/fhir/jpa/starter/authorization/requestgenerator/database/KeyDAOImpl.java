package ca.uhn.fhir.jpa.starter.authorization.requestgenerator.database;

import ca.uhn.fhir.jpa.starter.authorization.requestgenerator.ResourceNotFoundException;
