...
- [This project](https://github.com/HL7-DaVinci/test-pct-payer) checked out. You may wish to create a GitHub Fork of the project and check that out instead so that you can customize the project and save the results to GitHub.
...
inside `docker-compose.yml` to `8888:8083`, where 8888 is a port of your choice.
